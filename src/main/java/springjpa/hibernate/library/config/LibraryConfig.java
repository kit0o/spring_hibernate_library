package springjpa.hibernate.library.config;
...
@Configuration
@ComponentScan("springjpa.hibernate.library")
@EnableWebMvc
@PropertySource("classpath:hibernate.properties")
@EnableJpaRepositories("springjpa.hibernate.library.repositories")
...
public class LibraryConfig implements WebMvcConfigurer {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        em.setPackagesToScan("springjpa.hibernate.library.models");
